...
[![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ](https://charts.pascaliske.dev/charts/hammond/)[![Version: 1.1.0](https://img.shields.io/badge/Version-1.1.0-informational?style=flat-square) ](https://charts.pascaliske.dev/charts/hammond/)[![AppVersion: v0.0.24](https://img.shields.io/badge/AppVersion-v0.0.24-informational?style=flat-square) ](https://charts.pascaliske.dev/charts/hammond/)
...
| image.repository | string | `"alfhou/hammond"` | The repository to pull the image from. |
...
| podSecurityContext | string | `nil` | Pod-level security attributes. More info [here](https://kubernetes.io/docs/reference/kubernetes-api/workload-resources/pod-v1/#security-context). |
