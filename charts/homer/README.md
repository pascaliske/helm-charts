...
[![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ](https://github.com/pascaliske/helm-charts/tree/master/charts/homer)[![Version: 0.2.1](https://img.shields.io/badge/Version-0.2.1-informational?style=flat-square) ](https://github.com/pascaliske/helm-charts/tree/master/charts/homer)[![AppVersion: v22.08.1](https://img.shields.io/badge/AppVersion-v22.08.1-informational?style=flat-square) ](https://github.com/pascaliske/helm-charts/tree/master/charts/homer)
...
| image.tag | string | `"v22.10.1"` | The docker tag, if left empty chart's appVersion will be used. |
