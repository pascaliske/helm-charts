...
[![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ](https://github.com/pascaliske/helm-charts/tree/master/charts/gitlab)[![Version: 1.3.2](https://img.shields.io/badge/Version-1.3.2-informational?style=flat-square) ](https://github.com/pascaliske/helm-charts/tree/master/charts/gitlab)[![AppVersion: 15.5.1-ce.0](https://img.shields.io/badge/AppVersion-15.5.1--ce.0-informational?style=flat-square) ](https://github.com/pascaliske/helm-charts/tree/master/charts/gitlab)
...
| image.tag | string | `"15.5.1-ce.0"` | The docker tag, if left empty chart's appVersion will be used. |
