...
*/}}
{{- define "home-assistant.certificate.secretName" -}}
{{- if not (empty .Values.certificate.secretName) }}
{{- .Values.certificate.secretName }}
{{- else }}
{{- include "home-assistant.certificate.name" . }}
{{- end }}
{{- end }}
...
*/}}
{{- define "home-assistant.certificate.issuerRefName" -}}
...
*/}}
{{- define "home-assistant.ingressRoute.tlsSecretName" -}}
