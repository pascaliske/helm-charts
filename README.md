...
| [`code-server`](https://charts.pascaliske.dev/charts/code-server)                 | `0.2.1` |      `4.4.0`       |
...
| [`gitlab`](https://charts.pascaliske.dev/charts/gitlab)                           | `1.0.0` |   `15.1.1-ce.0`    |
| [`homer`](https://charts.pascaliske.dev/charts/homer)                             | `0.0.2` |     `22.02.2`      |
| [`linkding`](https://charts.pascaliske.dev/charts/linkding)                       | `0.0.4` |      `1.11.0`      |
| [`paperless`](https://charts.pascaliske.dev/charts/paperless)                     | `0.2.1` |      `1.7.1`       |
...
| [`uptime-kuma`](https://charts.pascaliske.dev/charts/uptime-kuma)                 | `0.1.0` |      `1.17.1`      |
